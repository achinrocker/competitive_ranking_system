...
<div id="template_wrapper">
    ...
    <div id="template_middle_subpage_index">
			...
			echo '<h4>'.mysql_real_escape_string($_SESSION["Admin"]).'(<a href="selectadmin.php?remove=logout">Remove</a>)</h4>';
			echo '<form method="post" action="delete1.php">
			Enter the Username to Delete<br />
	Username:<input type="text" class="inputs" name="username" pattern="[a-zA-Z0-9]+[_a-zA-Z0-9]*"
