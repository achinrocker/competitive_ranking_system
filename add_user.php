...
<div id="template_wrapper">
	...
	if(isset($_POST['add'])&&isset($_POST['handle'])&&isset($_POST['name'])&&isset($_POST['college'])&&isset($_POST['country']))
	{
	if(!empty($_POST['handle'])&&!empty($_POST['name'])&&!empty($_POST['college'])&&!empty($_POST['country'])){
		include "connect.php";
...
$college2 = array_search($college,$final);
echo $college2;
...
foreach ($final as $row) {
	//$college2 = array_search($college,$row);
   /*
...
$sql = "INSERT INTO detail ".
       "VALUES ".
       "('$handle','$name','$country',0,0,0,0,0,0,0,0,'$college')";

/*
mysql_select_db('admin_test');
*/
...
<div id="template_middle_subpage_kap">
Please fill the form to add the user:<br />
		<!--<form action="<?php /*echo $_SERVER['PHP_SELF'];*/?>" method="POST">-->
		ALL FIELDS ARE MANDATORY.
		<form method="post" action="<?php $_PHP_SELF ?>">
			Username:<br /><input type="text" class="inputs" name="handle" pattern="[a-zA-Z0-9]+[_a-zA-Z0-9]*"
oninvalid="setCustomValidity('Please enter only AlphaNumerics ')"
             onchange="try{setCustomValidity('')}catch(e){}" /> <br />
			Name:<br /><input type="text" class="inputs" name="name" pattern="[a-zA-Z ]+"
oninvalid="setCustomValidity('Please enter only Alphabets ')"
             onchange="try{setCustomValidity('')}catch(e){}"/><br />
			Country:<br /><input type="text" class="inputs" name="country" pattern="[a-zA-Z]+"
oninvalid="setCustomValidity('Please enter only Alphabets ')"
             onchange="try{setCustomValidity('')}catch(e){}"/><br />
			College:<br /><select name="college" class="custom-dropdown" value="options" autofocus="autofocus" autocorrect="off" autocomplete="on">
	...
	<option value="4" data-alternative-spellings="IIT">Indian Institute of Technology Kanpur</option>
			...
			<option value="2" data-alternative-spellings="SRM Institute">SRM Institute of Science and Technology</option>
			...
			<option value="29" data-alternative-spellings="NITJ">Dr. B. R. Ambedkar National Institute of Technology</option>
			...
			<option value="39" data-alternative-spellings="Amazon">Amazon India</option>
			...
			<option value="87" data-alternative-spellings="Google">Google India</option>
			...
			<option value="111" data-alternative-spellings="CHARUSAT">Charotar University of Science and Technology</option>
			...
			<option value="130" data-alternative-spellings="Facebook">Facebook India</option>
			...
			<option value="136" data-alternative-spellings="Infosys">Infosys</option>
			...
			<option value="156" data-alternative-spellings="MS India">Microsoft India Private Limited</option>
			...
			<!--college:<br /><input type="text" name="college">-->
			<input name="add" type="submit" value="Submit" id="submitbutton" />
		</form>
	</div>	
