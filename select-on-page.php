...
echo '		<h2>No college Selected</h2>
			<form action="select.php" method="POST" style="margin:10px" id="select_college" size="100">
			<select name="college" value="options" autofocus="autofocus" autocorrect="off" autocomplete="off">
