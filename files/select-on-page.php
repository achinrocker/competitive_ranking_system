...
echo '
			<h4>'.mysql_real_escape_string($_COOKIE["Name"]).'(<a href="select.php">Remove</a>)</h4>
			
			<p><img src="college/'.mysql_real_escape_string($_COOKIE["Image"]).'" width="100" height="100"/>
			</p>
		';
}
...
if($show)
echo '		
			<br /><h2>Select Your College</h2>
			<p><br/>
			<form action="select.php" method="POST" style="margin:10px" id="select_college">
			<select name="college" class="custom-dropdown" "value="options" autofocus="autofocus" autocorrect="on" autocomplete="on" size="1">
	...
	<option value="4" data-alternative-spellings="IIT">Indian Institute of Technology Kanpur</option>
			...
			<option value="1" data-alternative-spellings="Jaypee Institute of Information Technology">JIIT</option>
			...
			<option value="160" data-alternative-spellings="Kota">IIIT Kota</option>
			<option value="161" data-alternative-spellings="Bombay">IIM Bombay</option>
			<option value="162" data-alternative-spellings="Guru">Guru Jambheswar</option>
			<option value="163" data-alternative-spellings="Jan">JCD</option>
			<option value="164" data-alternative-spellings="Jodhpur">MBM Jodhpur</option>
			<option value="165" data-alternative-spellings="Rohtak">MDU Rohtak</option>
			<option value="166" data-alternative-spellings="Allahbad">University of Allahbad</option>
			</select>
