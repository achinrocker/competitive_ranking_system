...
<div id="template_wrapper">
    ...
    <div id="template_middle_subpage_index">
			<h4>';echo mysql_real_escape_string($_SESSION["Admin"]); echo '(<a href="selectadmin.php?remove=logout">Remove</a>)</h4>
			<h4><a href="admin.php">Back</a></h4>
			<form method="post" action="rank.php">
			Enter the Username to Update the Rank<br />
		Username:&nbsp;&nbsp;<input type="text" name="username" class="inputs" pattern="[a-zA-Z0-9]+[_a-zA-Z0-9]*" oninvalid="setCustomValidity(\'Please enter only AlphaNumerics \')"
             onchange="try{setCustomValidity(\'\'s)}catch(e){}" />
		<br />Enter the Contest:<select name="contest" class="custom-dropdown" />
